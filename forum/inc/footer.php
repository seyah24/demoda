...
<footer class="py-5 bg-gradient-navy">
            <div class="container">
              ...
              <p class="m-0 text-center text-white">Phát triển bởi: <a href="https://www.facebook.com/ptbsw">PTBSW</a></p>
          </div>
        </footer>
    ...
    <!-- Sparkline -->
    <script src="<?php echo ROOT ?>plugins/sparklines/sparkline.js"></script>
    <!-- Select2 -->
    <script src="<?php echo ROOT ?>plugins/select2/js/select2.full.min.js"></script>
    <!-- JQVMap -->
    <script src="<?php echo ROOT ?>plugins/jqvmap/jquery.vmap.min.js"></script>
    <script src="<?php echo ROOT ?>plugins/jqvmap/maps/jquery.vmap.usa.js"></script>
    <!-- jQuery Knob Chart -->
    <script src="<?php echo ROOT ?>plugins/jquery-knob/jquery.knob.min.js"></script>
    <!-- daterangepicker -->
