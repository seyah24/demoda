		...
		<div class="card-body">
            ...
            ?>
                <div class="d-flex w-100 align-items-center img-item">
                    <span><img src="<?php echo fr_url.$upload_path.'/'.$img."?v=".(time()) ?>" width="150px" height="100px" style="object-fit:cover;" class="img-thumbnail" alt=""></span>
...
<script>
	...
	function delete_img($path){
        ...
        $.ajax({
            url: _fr_url_+'classes/Master.php?f=delete_img',
            data:{path:$path},
            method:'POST',
            dataType:"json",
            error:err=>{
