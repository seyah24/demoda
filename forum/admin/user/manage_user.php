		...
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group">
					...
					<small><i>Để trống trường này nếu không muốn đổi mật khẩu.</i></small>
                    <?php endif; ?>
				</div>
                <div class="form-group">
                    ...
                    <option value="2" <?php echo isset($meta['type']) && $meta['type'] == 2 ? 'selected' : '' ?>>Mod</option>
                    </select>
                    <option value="1" <?php echo isset($meta['type']) && $meta['type'] == 4 ? 'selected' : '' ?>>Member</option>
                    <option value="2" <?php echo isset($meta['type']) && $meta['type'] == 4 ? 'selected' : '' ?>>Registered User</option>
                    </select>
                </div>
				<div class="form-group">
...
<script>
	...
	$('#manage-user').submit(function(e){
		...
		start_loader()
		$.ajax({
			url:_fr_url_+'classes/Users.php?f=save',
