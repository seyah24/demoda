      ...
      <div class="card-body rounded-0">
        <form id="register-form" action="" method="post">
          ...
          <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  <div class="form-group">
                      <label for="username" class="control-label">Tên tài khoản (username)</label>
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  ...
                  <div class="custom-file">
                    ...
                    <label class="custom-file-label rounded-0" for="customFile">Chọn file</label>
                  </div>
          </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
...
function displayImg(input,_this) {
  ...
  $(document).ready(function(){
    ...
    $('#register-form').submit(function(e){
        ...
        start_loader()
        $.ajax({
            url:_fr_url_+"classes/Users.php?f=registration",
            method:'POST',
            type:'POST',
            ...
            error:err=>{
                console.log(err)
                alert('ID:003-registerforum\nẢnh avatar quá nặng, bạn kiên nhẫn chờ chút.')
                end_loader()
            },
