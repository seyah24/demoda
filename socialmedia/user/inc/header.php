...
<head>
  ...
  <link rel="stylesheet" href="<?php echo ROOT ?>plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
    ...
    <!-- dropzonejs -->
    <link rel="stylesheet" href="<?php echo ROOT ?>plugins/dropzone/min/dropzone.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="<?php echo ROOT ?>dist/css/adminlte.css">
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="<?php echo ROOT ?>plugins/summernote/summernote-bs4.min.css">
     <!-- SweetAlert2 -->
  <link rel="stylesheet" href="<?php echo ROOT ?>plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
    ...
    <!-- SweetAlert2 -->
    <script src="<?php echo ROOT ?>plugins/sweetalert2/sweetalert2.min.js"></script>
    <!-- Toastr -->
    <script src="<?php echo ROOT ?>plugins/toastr/toastr.min.js"></script>
    <script>
        var _sc_url_ = '<?php echo ROOT ?>';
    </script>
    ...
    #main-header:before{
        ...
        width:100%;
        height:100%;
        background-image:url(<?php echo sc_url.$_settings->info('cover') ?>);
