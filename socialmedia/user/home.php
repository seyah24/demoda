        ...
        <div class="card-body">
          <div class="container-fluid">
            ...
            <div>
              ...
              <?php 
              if(isset($row['upload_path']) && is_dir(sc_app.$row['upload_path'])):
              $files = array();
              $fopen = scandir(sc_app.$row['upload_path']);
              if(count($fopen) > 2):
              ?>
              <?php 
...
<script>
  ...
  function update_like(post_id, status){
		$.ajax({
			url:_sc_url_+"classes/Master.php?f=update_like",
			method:'POST',
	...
	function post_comment(post_id){
		...
		start_loader()
		$.ajax({
			url:_sc_url_+"classes/Master.php?f=save_comment",
			method:'POST',
  ...
  function delete_post($id){
		start_loader();
		$.ajax({
			url:_sc_url_+"classes/Master.php?f=delete_post",
			method:"POST",
			data:{id: $id},
			dataType:"json",
			error:err=>{
	...
	function delete_comment($id){
		start_loader();
		$.ajax({
			url:_sc_url_+"classes/Master.php?f=delete_comment",
			method:"POST",
			data:{id: $id},
			dataType:"json",
			error:err=>{
