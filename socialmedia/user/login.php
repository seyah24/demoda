    ...
    <div class="d-flex w-100 px-4 h-100 align-items-center">
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="card card-navy my-2">
          <div class="card-body">
            <p class="login-box-msg">Nhập thông tin tài khoản</p>
            <form id="ulogin-frm" action="" method="post">
              ...
              <div class="row">
                ...
                <div class="col-12 text-center">
                  <a href="<?= sc_url ?>admin">Trang Admin</a>
                </div>
                <!-- /.col -->
              </div>
            </form>
  ...
  $(document).ready(function(){
    ...
    $('#ulogin-frm').submit(function(e) {
        ...
        if ($('.err_msg').length > 0)
            $('.err_msg').remove()
        $.ajax({
            url: _sc_url_ + 'classes/Login.php?f=user_login',
            method: 'POST',
            data: $(this).serialize(),
            error: err => {
                console.log(err)
            ...
            success: function(resp) {
                if (resp) {
                    ...
                    if (resp.status == 'success') {
                        location.replace(_sc_url_ + 'user');
